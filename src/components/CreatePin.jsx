        ...
        <div className='flex flex-col flex-1 gap-6 lg:pl-5 mt-5 w-full '>
          ...
          <div className='flex flex-col'>
            <div>
              ...
              >
                <option value="other" className='bg-white'>Selete the category</option>

                {categories.map(cat => (
                  <option className='text-base border-0 outline-none catpitalize bg-white text-black ' value={cat.name}>
                    {cat.name}
                  </option>
                ))}
              </select>
